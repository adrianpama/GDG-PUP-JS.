...
// Using let
let name = "Adrian Pama"; // Define a string here, e.g., "Juan Cruz"
...
const favoriteBooks = ["le fleur du mal", "Brave New World", "Fahrenheit 451"]; // Define an array here, e.g., ["1984", "Brave New World", "Fahrenheit 451"]
...
var temperature = 37.0; // Define a number here, e.g., 22.5
